    ...
    <section class="about">
        ...
        <div class="about_sentence">
            ...
            <div class="lineBox">
                ...
                <hr class="heading_line red">
                <hr class="heading_line green">
            </div>
            <p class="about_description">Circle Squareは、主に慶應義塾大学SFCの在学生や、これからSFCに入学する新入生の方へ向けた、サークル情報掲載サイトです。サイトの特徴として、サークルごとにカテゴリーが設けられており、各サークルのページにはそれぞれの活動日、年間の活動内容や連絡先が掲載されています。現在、カテゴリー検索、キーワード検索が可能となっています。サークル情報は、SFC新歓実行委員会様のご協力をいただいております。サークル情報の修正、追加などに関しましては、コンタクトページまたは、circlesquare.sfc@gmail.comまでご連絡ください。また当サイトご利用につきましては、サイトポリシーをご覧ください。</p>
        </div>
